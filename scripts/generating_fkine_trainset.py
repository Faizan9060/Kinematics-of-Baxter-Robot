...
for itr in range(0,6000):
    ...
    y = round(trans[1][3],3)
    z = round(trans[2][3],3)
    print(q1,q2,q3,q4,q5,q6,q7,x,y,z)
    data = [q1,q2,q3,q4,q5,q6,q7,x,y,z]

    print("counter",itr)

    # with open('/home/faizan/Documents/ir_lab/train.csv','+a',newline='') as obj:
